...
namespace CapenexisLearners2022.Controllers
{
    ...
    {
        private readonly CapenexisLearners2022Context _context;

        public FacilitatorsController(CapenexisLearners2022Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Facilitator != null ? 
                          ...
                          Problem("Entity set 'CapenexisLearners2022Context.Facilitator'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("FacilitatorId,FacilitatorName,FacilitatorSurname")] Facilitator facilitator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FacilitatorId,FacilitatorName,FacilitatorSurname")] Facilitator facilitator)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CapenexisLearners2022Context.Facilitator'  is null.");
            }
            var facilitator = await _context.Facilitator.FindAsync(id);
            if (facilitator != null)
            {
